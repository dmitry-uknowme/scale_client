    ...
    (function ($$) {
        class $scale_dash_camera extends $.$scale_dash_camera {
            ...
            init_remote_sdp(pc) {
                ...
                try {
                    const data = $mol_fetch.json("http://localhost:8083/stream/receiver/CAMERA_1", {
                        method: "POST",
                        body: formData,
                    });
        ...
        __decorate([
            $mol_mem
        ], $scale_dash_camera.prototype, "id", null);
        __decorate([
            $mol_mem
...
(function ($) {
    class $scale_form_enter extends $mol_form {
        ...
        Number_channel_control() {
            const obj = new this.$.$mol_paragraph();
            obj.title = () => this.autoNumber_IN();
            return obj;
        }
        Number_channel_field() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => "Распознанный гос. номер";
            obj.bid = () => this.number_channel_bid();
            obj.Content = () => this.Number_channel_control();
            return obj;
        }
        number_bid() {
            return "";
    ...
    __decorate([
        $mol_mem
    ], $scale_form_enter.prototype, "Number_channel_control", null);
    __decorate([
        $mol_mem
    ], $scale_form_enter.prototype, "Number_channel_field", null);
    __decorate([
        $mol_mem
