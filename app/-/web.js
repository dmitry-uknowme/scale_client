...
(function ($) {
    class $mol_icon_video extends $mol_icon {
        path() {
            return "M17,10.5V7C17,6.45 16.55,6 16,6H4C3.45,6 3,6.45 3,7V17C3,17.55 3.45,18 4,18H16C16.55,18 17,17.55 17,17V13.5L21,17.5V6.5L17,10.5Z";
        }
    }
    $.$mol_icon_video = $mol_icon_video;
})($ || ($ = {}));
//mol/icon/video/-view.tree/video.view.tree.ts
;
"use strict";
var $;
(function ($) {
    class $mol_icon_video_plus extends $mol_icon {
        path() {
            return "M17,10.5V7C17,6.45 16.55,6 16,6H4C3.45,6 3,6.45 3,7V17C3,17.55 3.45,18 4,18H16C16.55,18 17,17.55 17,17V13.5L21,17.5V6.5L17,10.5M14,13H11V16H9V13H6V11H9V8H11V11H14V13Z";
        }
    }
    $.$mol_icon_video_plus = $mol_icon_video_plus;
})($ || ($ = {}));
//mol/icon/video/plus/-view.tree/plus.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $scale_settings_camera extends $mol_row {
        sub() {
            return [
                this.Name(),
                this.Url(),
        ...
        Url() {
            const obj = new this.$.$mol_textarea();
            obj.hint = () => "RTSP URL";
            obj.value = (next) => this.rtsp_url(next);
            return obj;
        }
        Save_icon() {
    ...
    __decorate([
        $mol_mem
    ], $scale_settings_camera.prototype, "name", null);
    __decorate([
        $mol_mem
    ], $scale_settings_camera.prototype, "Name", null);
    __decorate([
        $mol_mem
    ], $scale_settings_camera.prototype, "rtsp_url", null);
    __decorate([
        $mol_mem
    ], $scale_settings_camera.prototype, "Url", null);
    __decorate([
        $mol_mem
    ], $scale_settings_camera.prototype, "Save_icon", null);
    __decorate([
        $mol_mem
    ], $scale_settings_camera.prototype, "delete", null);
    __decorate([
        $mol_mem
    ], $scale_settings_camera.prototype, "Save", null);
    __decorate([
        $mol_mem
    ], $scale_settings_camera.prototype, "Delete_icon", null);
    __decorate([
        $mol_mem
    ], $scale_settings_camera.prototype, "Delete", null);
    $.$scale_settings_camera = $scale_settings_camera;
})($ || ($ = {}));
//scale/settings/camera/-view.tree/camera.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $scale_settings extends $mol_list {
        rows() {
            return [
                this.Section()
            ];
        ...
        Polygon_name_field() {
            ...
            obj.name = () => "Наименование полигона";
            obj.bid = () => this.polygon_name_bid();
            obj.Content = () => this.Polygon_name_control();
            return obj;
        }
        address_local_bid() {
            return "";
        ...
        Address_local_control() {
            const obj = new this.$.$mol_string();
            obj.hint = () => "http://192.168.88.67:888";
            obj.value = (val) => this.api_url(val);
            return obj;
        }
        Address_local_field() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => "Адрес локального сервера";
            obj.bid = () => this.address_local_bid();
            obj.Content = () => this.Address_local_control();
            return obj;
        }
        address_websocket_bid() {
            return "";
        }
        websocket_url(val) {
            if (val !== undefined)
        ...
        Address_websocket_control() {
            const obj = new this.$.$mol_string();
            obj.hint = () => "ws://192.168.88.67:8877/connection/websocket";
            obj.value = (val) => this.websocket_url(val);
            return obj;
        }
        Address_websocket_field() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => "Адрес вебсокет сервера";
            obj.bid = () => this.address_websocket_bid();
            obj.Content = () => this.Address_websocket_control();
            return obj;
        }
        Names() {
            const obj = new this.$.$mol_form_group();
            obj.sub = () => [
                this.Polygon_name_field(),
                this.Address_local_field(),
                this.Address_websocket_field()
            ];
            return obj;
        }
        signup(val) {
        ...
        Add_icon() {
            const obj = new this.$.$mol_icon_video_plus();
            return obj;
        }
        Add_button() {
            const obj = new this.$.$mol_button_minor();
        ...
        Camera_row() {
            const obj = new this.$.$scale_settings_camera();
            return obj;
        }
        Camera_list() {
            const obj = new this.$.$mol_list();
    ...
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "polygon_name", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Polygon_name_control", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Polygon_name_field", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "api_url", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Address_local_control", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Address_local_field", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "websocket_url", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Address_websocket_control", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Address_websocket_field", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Names", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "signup", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Form", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Add_icon", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Add_button", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "add", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Camera_form", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Camera_row", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Camera_list", null);
    __decorate([
        $mol_mem
    ], $scale_settings.prototype, "Section", null);
    $.$scale_settings = $scale_settings;
})($ || ($ = {}));
//scale/settings/-view.tree/settings.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($scale_settings, {
            Names: {
...
//scale/settings/settings.view.css.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $scale_settings.prototype, "default_settings", null);
        __decorate([
            $mol_mem
        ], $scale_settings.prototype, "settings", null);
        __decorate([
            $mol_mem
        ], $scale_settings.prototype, "polygon_name", null);
        __decorate([
...
//scale/settings/settings.view.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    ...
    (function ($$) {
        class $scale_centrifuge extends $.$scale_centrifuge {
            ...
            client() {
                if (this.websocket_url()) {
                    return new $scale_centrifuge_lib(this.websocket_url());
                }
            }
            state(next) {
                return next;
            ...
            autoNumber_stack_add(data) {
                const prev = this.autoNumber_stack()?.filter((auto) => !(auto.number === data.number && auto.direction === data.direction)) ?? [];
            ...
            autoNumber_channel_IN(next) {
                if (next !== undefined) {
                    if ($mol_state_arg.value("dash") !== "form_enter" &&
        ...
        __decorate([
            $mol_mem
        ], $scale_centrifuge.prototype, "websocket_url", null);
        __decorate([
            $mol_mem
...
(function ($) {
    class $scale_api extends $mol_object {
        ...
        getActs(filter = {
            ...
            const response = $mol_fetch.json(`${this.base_url()}/getActs${Object.keys(filter).length
                ? `?${Object.keys(filter)
        ...
        getOrganizations(filter = {
            ...
            const BASE_URL = this.base_url();
            const response = $mol_fetch.json(`${this.base_url()}/getUsers?status=${filter.status}${filter.role ? `&role=${filter.role}` : ""}`, {
                method: "GET",
            });
            if (response.status !== "success") {
                throw new Error(`Response failed with status ${response.status}`);
        ...
        getCargoCategories() {
            const BASE_URL = this.base_url();
            const response = $mol_fetch.json(`${this.base_url()}/getWasteCategories`, {
                method: "GET",
            });
            if (response.status !== "success") {
                throw new Error(`Response failed with status ${response.status}`);
    ...
    __decorate([
        $mol_mem
    ], $scale_api.prototype, "base_url", null);
    $.$scale_api = $scale_api;
})($ || ($ = {}));
//scale/api/api.ts
;
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $scale_dash.prototype, "Camera", null);
    __decorate([
        $mol_mem_key
...
var $;
(function ($) {
    class $scale_form_detected_stack extends $mol_section {
        title() {
            return "Очередь";
        }
        level() {
        ...
        content() {
            return [
                this.Detected_auto_stack(),
                this.List_drop()
            ];
        }
        detected_auto_number(id, next) {
            if (next !== undefined)
                return next;
            return "";
        }
        detected_auto_html(id) {
            return "";
        }
        detected_auto_uri(id) {
            return "";
        }
        ...
        Detected_number(id) {
            const obj = new this.$.$mol_paragraph();
            obj.title = () => this.detected_auto_number(id);
            return obj;
        }
        detected_auto_direction(id, next) {
            if (next !== undefined)
                return next;
            return "";
        }
        Detected_direction(id) {
            const obj = new this.$.$mol_paragraph();
            obj.title = () => this.detected_auto_direction(id);
            return obj;
        }
        Detected_auto_link(id) {
            const obj = new this.$.$mol_link();
            obj.uri = () => this.detected_auto_uri(id);
            obj.sub = () => [
                this.Detected_number(id),
                this.Detected_direction(id)
            ];
            return obj;
        }
        Detected_auto_drop(id) {
            const obj = new this.$.$mol_drop();
            obj.adopt = (transfer) => this.transfer_adopt(transfer);
            obj.receive = (obj) => this.receive_before(id, obj);
            obj.Sub = () => this.Detected_auto_link(id);
            return obj;
        }
        Detected_auto_stack_row(id) {
            const obj = new this.$.$mol_drag();
            obj.transfer = () => ({
                "text/plain": this.detected_auto_number(id),
                "text/html": this.detected_auto_html(id),
                "text/uri-list": this.detected_auto_uri(id)
            });
            obj.Sub = () => this.Detected_auto_drop(id);
            return obj;
        }
        detected_auto_stack() {
            return [
                this.Detected_auto_stack_row("0")
            ];
        }
        Detected_auto_stack() {
            const obj = new this.$.$mol_list();
            obj.rows = () => this.detected_auto_stack();
            return obj;
        }
        receive(obj) {
            if (obj !== undefined)
    ...
    __decorate([
        $mol_mem_key
    ], $scale_form_detected_stack.prototype, "detected_auto_number", null);
    __decorate([
        $mol_mem
    ], $scale_form_detected_stack.prototype, "transfer_adopt", null);
    __decorate([
        $mol_mem_key
    ], $scale_form_detected_stack.prototype, "receive_before", null);
    __decorate([
        $mol_mem_key
    ], $scale_form_detected_stack.prototype, "Detected_number", null);
    __decorate([
        $mol_mem_key
    ], $scale_form_detected_stack.prototype, "detected_auto_direction", null);
    __decorate([
        $mol_mem_key
    ], $scale_form_detected_stack.prototype, "Detected_direction", null);
    __decorate([
        $mol_mem_key
    ], $scale_form_detected_stack.prototype, "Detected_auto_link", null);
    __decorate([
        $mol_mem_key
    ], $scale_form_detected_stack.prototype, "Detected_auto_drop", null);
    __decorate([
        $mol_mem_key
    ], $scale_form_detected_stack.prototype, "Detected_auto_stack_row", null);
    __decorate([
        $mol_mem
    ], $scale_form_detected_stack.prototype, "Detected_auto_stack", null);
    __decorate([
        $mol_mem
    ], $scale_form_detected_stack.prototype, "receive", null);
    __decorate([
        $mol_mem
    ], $scale_form_detected_stack.prototype, "receive_trash", null);
    __decorate([
        $mol_mem
    ], $scale_form_detected_stack.prototype, "Trash_icon", null);
    __decorate([
        $mol_mem
    ], $scale_form_detected_stack.prototype, "Trash", null);
    __decorate([
        $mol_mem
    ], $scale_form_detected_stack.prototype, "Trash_drop", null);
    __decorate([
        $mol_mem
    ], $scale_form_detected_stack.prototype, "Scroll", null);
    __decorate([
        $mol_mem
    ], $scale_form_detected_stack.prototype, "List_drop", null);
    $.$scale_form_detected_stack = $scale_form_detected_stack;
})($ || ($ = {}));
//scale/form/detected/stack/-view.tree/stack.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
//scale/form/detected/stack/stack.view.css.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $scale_form_detected_stack extends $.$scale_form_detected_stack {
            open_enter_form() {
                $mol_state_arg.dict({ "": "dash", dash: "form_enter" });
            }
            open_exit_form() {
            ...
            transfer_adopt(transfer) {
                ...
                if (!uri)
                    return;
                return this.detected_auto_stack_list().find((task) => this.detected_auto_uri(task) === uri);
            }
            receive(task) {
            ...
            receive_trash(task) {
                this.detected_auto_stack_list(this.detected_auto_stack_list().filter((p) => p !== task));
            }
        }
        __decorate([
            $mol_action
        ], $scale_form_detected_stack.prototype, "open_enter_form", null);
        __decorate([
            $mol_action
        ], $scale_form_detected_stack.prototype, "open_exit_form", null);
        __decorate([
            $mol_action
        ], $scale_form_detected_stack.prototype, "detetcted_auto_stack_next", null);
        __decorate([
            $mol_mem
        ], $scale_form_detected_stack.prototype, "detected_auto_stack_list", null);
        __decorate([
            $mol_mem
        ], $scale_form_detected_stack.prototype, "detected_auto_stack", null);
        __decorate([
            $mol_mem_key
        ], $scale_form_detected_stack.prototype, "detected_auto_order", null);
        __decorate([
            $mol_mem_key
        ], $scale_form_detected_stack.prototype, "detected_auto_uri", null);
        __decorate([
            $mol_mem_key
        ], $scale_form_detected_stack.prototype, "detected_auto_number", null);
        __decorate([
...
//scale/form/detected/stack/stack.view.ts
;
"use strict";
var $;
(function ($) {
    class $scale_form_enter extends $mol_list {
        ...
        Detected_stack() {
            const obj = new this.$.$scale_form_detected_stack();
            return obj;
        }
    }
    __decorate([
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_action
        ], $scale_form_enter.prototype, "open_enter_form", null);
        __decorate([
            $mol_action
        ], $scale_form_enter.prototype, "open_exit_form", null);
        __decorate([
            $mol_action
        ], $scale_form_enter.prototype, "enter_submit", null);
        __decorate([
        ...
        __decorate([
            $mol_action
        ], $scale_form_enter.prototype, "detetcted_auto_stack_next", null);
        __decorate([
            $mol_mem
        ], $scale_form_enter.prototype, "detected_auto_stack_list", null);
        $$.$scale_form_enter = $scale_form_enter;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $scale_form_exit.prototype, "Detected_stack", null);
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $scale_form_exit.prototype, "acts_options", null);
        __decorate([
            $mol_action
        ], $scale_form_exit.prototype, "open_enter_form", null);
        __decorate([
            $mol_action
        ], $scale_form_exit.prototype, "open_exit_form", null);
        __decorate([
            $mol_action
        ], $scale_form_exit.prototype, "detetcted_auto_stack_next", null);
        __decorate([
            $mol_mem
        ], $scale_form_exit.prototype, "detected_auto_stack_list", null);
        $$.$scale_form_exit = $scale_form_exit;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $scale_app.prototype, "settings", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $scale_app.prototype, "Settings_body", null);
    __decorate([
        $mol_mem
    ], $scale_app.prototype, "Settings", null);
    $.$scale_app = $scale_app;
