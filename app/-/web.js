...
var $;
(function ($) {
    class $scale_store extends $mol_view {
        api() {
        ...
        attr() {
            return {
                ...super.attr(),
                act_list_all: this.act_list_all(),
                act_list_onTerritory: this.act_list_onTerritory(),
                act_list_completed: this.act_list_completed()
            };
        }
    }
    __decorate([
        $mol_mem
    ], $scale_store.prototype, "api", null);
    $.$scale_store = $scale_store;
})($ || ($ = {}));
//scale/store/-view.tree/store.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $scale_store extends $.$scale_store {
            act_list_all() {
                return this.api().getActs({
                    status: $scale_modelActStatus.ON_TERRITORY,
                });
            }
            act_list_onTerritory(reset) {
                return this.api().getActs({
                    status: $scale_modelActStatus.ON_TERRITORY,
                });
            }
        ...
        __decorate([
            $mol_mem
        ], $scale_store.prototype, "act_list_all", null);
        __decorate([
            $mol_mem
        ], $scale_store.prototype, "act_list_onTerritory", null);
        __decorate([
            $mol_action
        ], $scale_store.prototype, "act_list_onTerritory_update", null);
        __decorate([
            $mol_mem
        ], $scale_store.prototype, "act_list_completed", null);
        $$.$scale_store = $scale_store;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//scale/store/store.view.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $scale_dash.prototype, "Store", null);
    __decorate([
        $mol_mem
...
(function ($) {
    class $scale_form_enter extends $mol_form {
        ...
        act_list_onTerritory_update() {
            return this.Store().act_list_onTerritory_update();
        }
        Store() {
            const obj = new this.$.$scale_store();
            return obj;
    ...
    __decorate([
        $mol_mem
    ], $scale_form_enter.prototype, "Store", null);
    __decorate([
        $mol_mem
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $scale_app.prototype, "Store", null);
    __decorate([
        $mol_mem
